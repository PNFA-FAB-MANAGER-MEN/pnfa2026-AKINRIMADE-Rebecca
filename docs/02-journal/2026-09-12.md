...
- Un boîtier a été conçu puis découpé, probablement destiné à accueillir une partie du système électronique. 
- En parallèle, une recherche a été menée sur la plateforme Printables afin de trouver un modèle 3D de voiture déjà prêt à l'impression, évitant ainsi de le modéliser entièrement à partir de zéro. 
- Ce modèle a ensuite été tranché dans BambuStudio, c'est-à-dire préparé et découpé en couches d'impression pour être envoyé à l'imprimante 3D. 
